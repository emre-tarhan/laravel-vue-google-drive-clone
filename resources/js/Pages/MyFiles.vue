            ...
            <table class="min-w-full">
                ...
                >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-neutral-300 flex items-center relative">
                        <svg v-if="file.is_favorite && !file.is_folder" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-3 h-3 ml-1 text-yellow-400 absolute top-3 left-8">
